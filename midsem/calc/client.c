...
int main() {
	...
	fprintf(stdout, "Calculator connected. Now use first letter for (m)ultiplication, (d)ivision for an operation.\n Example: \"m 7 8\" for multiplication \"d 7 8\" for division .You can also use space separated expressions i.e., \"4 + 5\" or \"5 - 4\" or \"78 * 4\" or \"34 / 2 \"\n");
